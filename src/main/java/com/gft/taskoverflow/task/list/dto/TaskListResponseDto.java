...
public record TaskListResponseDto(@NotNull Long id, @NotEmpty @Size(max = 100) String title, @NotNull Float position,
                                  @NotNull Long boardId, @NotNull List<TaskPreviewDto> tasks,
                                  @NotNull List<Customer> assignedCustomers, @NotNull SortOption sortOption,
